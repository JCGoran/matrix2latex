# -*- coding: utf-8 -*-
#
# matrix2latex documentation build configuration file, created by
# sphinx-quickstart on Sun Feb  9 14:50:03 2014.
#
...
sys.path.insert(0, os.path.abspath('../matrix2latex'))
...
htmlhelp_basename = 'matrix2latexdoc'
